...
[**5 Первая полноценная настройка роутера**](#5-первая-полноценная-настройка-роутера)
...
**После загрузки у вас может не работать доступ к интернету:** Для исправления этого заново сделайте "Flash image..." с OpenWRT-19.07.1-MiR3P-sysupgrade.bin, только в этот раз **снимите галочку с  "Keep settings"**. У меня эта проблема возникла, поэтому если вы следовали чётко по моим инструкциям, проблема должна была возникнуть и у вас. Желательно в любом случае проделать повторную прошивку.
