...
После чего WiFi будет настроен в режиме wpa2-enterprise с единственной учётной записью: root - FREERADIUS3_ROOT_PASSWORD. Можете протестировать, присоединившись к сети.