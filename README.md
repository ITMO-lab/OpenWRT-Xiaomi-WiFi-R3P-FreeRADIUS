...
Аренду начинаем с "10", чтобы оставить место под зарезервированные адреса 192.0.0.0-10, а заканчиваем "256^3 - 10", что равно "16777206". Время аренды ставим на "2^31 - 1" часов, что соответствует "2147483647h". Снова применяем настройки ("Сохранить и применить...").
