...
#### **Также вы можете установить OpenWRT на любой другой роутер и настроить WPA2-Enterprise по инструкциям с пункта: [5. Первая полноценная настройка прошивки](#5-первая-полноценная-настройка-прошивки) и далее.**
...
[**7. Установка и подключение SQLite и SQLite-web для контроля учётных записей пользователей**](#7-установка-и-подключение-sqlite-и-sqlite-web-для-контроля-учётных-записей-пользователей)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/2/1.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/2/2.png)

Или же, если в роутер не воткнут кабель с интернетом (перекинул на ноут, чтобы переводить китайский)

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/2/3.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/2/4.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/2/5.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/2/6.png)

Думаю, тут очевидно, куда нажимать. Только не забудьте подключиться к новой Wi-Fi сети )

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/2/7.png)
...
Или воспользуйтесь его копией на github [miwifi_r3p_firmware_daddf_2.13.65.bin](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/raw/firmware/xiaomi-developer/miwifi_r3p_firmware_daddf_2.13.65.bin), ведь его могут убрать из открытых источников.

Далее по кабелю подключаемся или WiFi к роутеру и переходим на http://192.168.31.1

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/1.png)

Войдите в систему и найдите страницу, на которой вы можете обновить прошивку (найдите большую желтую точку с «i» внутри).

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/2.png)

Здесь выбираете обновление прошивки вручную.

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/3.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/4.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/5.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/6_2.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/7_2.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/8.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/9.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/10.png)

После чего у нас попросят пароль. Вводим тот самый пароль, что мы записывали и мы в роутере, готовы ставить прошивки.

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/3/11.png)
...
Скачиваем прошивку OpenWRT: [openwrt-ramips-mt7621-xiaomi_mir3p-squashfs-factory.bin](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/raw/firmware/openwrt-ramips-mt7621/openwrt-ramips-mt7621-xiaomi_mir3p-squashfs-factory.bin)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/1_1.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/photos/20200624_162705.jpg)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/photos/20200624_162631.jpg)

Конечно можно полностью разобрать корпус, выкрутив из под прорезиненных ножек 4 болта,

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/photos/20200624_162343.jpg)

Выковыряв ножом с боков пластиковые вставки,

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/photos/20200624_162501.jpg)

И достать плату роутера (с огромным радиатором)... 

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/photos/20200624_162400.jpg)

Но зачем нам все эти сложности, ведь нам нужен только доступ к UART разъёму?

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/photos/20200624_212857.jpg)

Просто отключаем роутер от питания, аккуратно ножом поддеваем правую пластиковую стенку,

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/photos/20200624_212925.jpg)

Теперь у нас есть доступ к разъёму. Можно даже к нему подпаять провода, нам нужны RX, TX и GND. Питание на 3.3 v не трогаем.

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/photos/20200624_213916.jpg)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/6.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/7.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/8.png)

Для этого нужно открыть "Сетевые подключения", найти ваш проводной адаптер. Правая кнопка мыши, его свойства...

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/9.png)
...
Прошивка ядра осуществляется через TFTP. [Программа для поднятия TFTP сервера](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/raw/firmware/programs/Tftpd64-4.00-setup.exe)

Для начала нам нужен файл ядра [openwrt-ramips-mt7621-xiaomi_mir3p-initramfs-kernel.bin](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/raw/firmware/openwrt-ramips-mt7621/openwrt-ramips-mt7621-xiaomi_mir3p-initramfs-kernel.bin)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/10.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/11.png)

Если процесс загрузки идёт хорошо, вы увидите такую картину. Мне удалось прошить ядро без разбора корпуса и пайки.

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/12.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/14.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/2.png)

После этого нажимаем "Flash image..."

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/3.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/4/4.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/1.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/2.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/8.png)

Далее настраиваем DHCP, чтобы не возникало проблем с перенаправлением при длительном стриминге данных. 

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/9.png)

Сначала с этим расширим область выделяемых адресов, меняя маску подсети на 255.0.0.0 и применяем ("Сохранить и применить...").

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/15.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/16.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/12.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/13.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/14.png)
...
![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/4.png)

Потом 5 G

![img](https://github.com/ITMO-lab/OpenWRT-Xiaomi-WiFi-R3P-FreeRADIUS/blob/images/screenshots/5/5.png)
...
Устанавливаю [sqlite-web](https://github.com/coleifer/sqlite-web) - простой сервис для администрирования SQLite. Важно отметить, что текущая версия, 0.3.6, имеет уязвимость безопасности, и я уже предложил [исправление через pull-request](https://github.com/coleifer/sqlite-web/pull/68). Если исправление на момент прочтения одобрили (скорее всего, тогда версия изменится на 0.3.7+), можете установить пакет через:

`pip3 install sqlite-web` - после этого обязательно проверьте версию.

Если же его не одобрили, тогда используем мой форк и устанавливаем пакет с исправлением угрозы безопасности. Его также можно сначала скачать на флешку, а потом смонтировать на роутере и установить, но после пункта [6. Установка FreeRADIUS и поднятие WPA2-Enterprise](#6-установка-freeradius-и-поднятие-wpa2-enterprise) на роутере уже установлен git и git-http:
